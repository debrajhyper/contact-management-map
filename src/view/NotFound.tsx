...
export function NotFound() {
    ...
    return (
        <div className="not_found_page w-full h-full py-16 px-8 flex flex-col flex-wrap justify-center items-center">
            ...
            <Link to={HOME_PATH} className="back-home inline-block border-2 border-neutral-800 text-white uppercase font-semibold py-3 px-4 transition-all drop-shadow-md bg-neutral-800 rounded-md hover:bg-neutral-900 hover:border-neutral-900">
                Back to home
            </Link>
        </div>
    )
